                ...
                <div class="cart-box">
                    ...
                    <ul class="cart-item-list">
                        <li class="cart-item" v-for="(item, index) in list" :key="index">
                            <div class="item-check" @click="onSelect(item)">
                                <span
                                    class="checkbox"
                                    :class="{
                            ...
                            <div class="item-num">
                                <div class="num-box">
                                    <a href="javascript:;" @click="decreaseItem(item)">-</a>
                                    <span>{{ item.quantity }}</span>
                                    <a href="javascript:;" @click="addItem(item)">+</a>
                                </div>
                            </div>
                            <div class="item-total">
                                {{ item.productTotalPrice }}
                            </div>
                            <div class="item-del" @click="modalVisible=true"></div>
                            <Modal
                                title="提示"
                                confirmText="确定"
                                :btnType="3"
...
export default {
    ...
    methods: {
        ...
        order(){
            if(this.list.every(item=>!item.productSelected)) Message.warning('请选择至少一件商品')
            else this.$router.push('/order/confirm')
        }
    },
}
</script>
