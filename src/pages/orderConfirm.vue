                    ...
                    <div class="item-address">
                        ...
                        <div class="addr-list clearfix">
                            ...
                            >
                                ...
                                <div class="action">
                                    <a href="javascript:;" class="fl" @click.stop="delAddress(item, index)">
                                        <svg class="icon icon-del">
                                            <use xlink:href="#icon-del"></use>
                                        </svg>
                                    </a>
                                    <a href="javascript:;" class="fr" @click.stop="editAddress(item)">
                            ...
                            <div class="addr-add" @click="openAddAddressModal">
...
export default {
    ...
    methods: {
        ...
        delAddress(item, index) {
            ...
            if (this.checkedIndex === index) this.userAction = 3
        ...
        submitAddress() {
            ...
            this.axios[method](url, params).then(() => {
                ...
                if (userAction === 3) {
                    this.checkedIndex = this.checkedIndex - 1
                }
            })
            this.closeModal()
        },
        ...
        orderSubmit() {
            const item = this.list[this.checkedIndex]
            this.axios
                .post('/orders', {
                    shippingId: item.id,
                })
